...
-- Dumping data for table bookmart.ci_sessions: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `orders_logs` (
  ...
  `created_at` datetime NOT NULL,
  `status` enum('Failed','Confirmed') NOT NULL,
...
INSERT INTO `users` (`user_id`, `country_id`, `user_type`, `first_name`, `last_name`, `dob`, `email`, `password`, `reset_code`, `phone`, `city`, `avatar`, `profile_desc`, `blocked`, `joined`) VALUES
    ...
    (2, 225, 'normal_user', 'Alex', 'Garrett', '0000-00-00', 'alex@gmail.com', '32250170a0dca92d53ec9624f336ca24', NULL, '', 'London', '', '', 0, '0000-00-00 00:00:00'),
