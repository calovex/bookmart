...
-- Dumping data for table bookmart.pages: ~13 rows (approximately)
...
INSERT INTO `products` (`product_id`, `title`, `author`, `cover_image`, `service_type`, `type`, `original_price`, `sale_price`, `shipping_costs`, `weightage`, `slug`, `meta_keywords`, `meta_desc`, `image1`, `image2`, `image3`, `summary`, `desc`, `views`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table bookmart.products_categories: ~84 rows (approximately)
