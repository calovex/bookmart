...
INSERT INTO `categories` (`category_id`, `name`, `slug`, `weightage`, `status`, `created_at`, `updated_at`) VALUES
  ...
  (6, 'Bulk Sales', 'bulk-sales', 4, 1, '0000-00-00 00:00:00', '2014-09-21 17:44:33'),
  (9, 'Free', 'free', 8, 1, '2014-09-20 21:53:09', '2014-09-21 17:40:34');
...
-- Dumping data for table bookmart.ci_sessions: ~1 rows (approximately)
/*!40000 ALTER TABLE `ci_sessions` DISABLE KEYS */;
INSERT INTO `ci_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
  ('0d9c04e164e1914224dc03d94b56449a', '::1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.120 Safari/537.36', 1411589113, 'a:9:{s:9:"user_data";s:0:"";s:13:"cart_contents";a:3:{s:32:"41e9d6180803753e750e254372d6dc0c";a:7:{s:5:"rowid";s:32:"41e9d6180803753e750e254372d6dc0c";s:2:"id";s:2:"10";s:3:"qty";s:1:"1";s:5:"price";s:2:"10";s:4:"name";s:31:"The Mysterious Affair at Styles";s:7:"options";a:3:{s:14:"original_price";s:2:"12";s:11:"cover_image";s:28:"mysteriousaffairatstyles.jpg";s:3:"url";s:68:"http://localhost/bookmart/product/10/the-mysterious-affair-at-styles";}s:8:"subtotal";i:10;}s:11:"total_items";i:1;s:10:"cart_total";i:10;}s:7:"user_id";s:1:"4";s:9:"user_type";s:5:"admin";s:10:"country_id";s:1:"0";s:10:"first_name";s:5:"Admin";s:9:"last_name";s:0:"";s:5:"email";s:18:"admin@bookmart.com";s:9:"logged_in";b:1;}');
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `paid_email` varchar(255) NOT NULL,
  `user_id` int(11) NOT NULL,
  `order_amount` float NOT NULL,
  `paid_amount` float NOT NULL,
  `order_id_sent` int(11) NOT NULL,
  `order_id_received` int(11) NOT NULL,
  `status` enum('Pending','Confirmed','Blocked','Failed') NOT NULL DEFAULT 'Pending',
  `created_time` datetime NOT NULL,
  `paid_time` datetime NOT NULL,
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- Dumping data for table bookmart.orders: ~1 rows (approximately)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`order_id`, `product_ids`, `gateway`, `txn_id`, `paid_email`, `user_id`, `order_amount`, `paid_amount`, `order_id_sent`, `order_id_received`, `status`, `created_time`, `paid_time`) VALUES
  (6, '10', 'Paypal', '', '', 4, 10, 0, 6, 0, 'Pending', '2014-09-25 01:34:05', '0000-00-00 00:00:00');
...
INSERT INTO `products_ebooks` (`products_ebooks_id`, `product_id`, `name`) VALUES
  ...
  (16, 13, 'Wuthering_Heights_by_Emily_Brontë.epub'),
  ...
  (26, 23, 'The_Prince_by_Niccolò_Machiavelli.epub'),
...
-- Dumping data for table bookmart.products_images: ~53 rows (approximately)
/*!40000 ALTER TABLE `products_images` DISABLE KEYS */;
INSERT INTO `products_images` (`products_images_id`, `product_id`, `is_cover`, `name`) VALUES
  (77, 28, 1, 'pride-and-prejudice.jpg'),
  (78, 28, 0, 'pride-prejudice-jane-austen-paperback-cover-art.jpg'),
  (79, 27, 1, 'eBook_601_32587.jpg'),
  (80, 27, 0, 'collins-classics.jpg'),
  (81, 26, 1, '22.jpg'),
  (82, 26, 0, 'alice06.jpg'),
  (83, 25, 1, '709306_w185.png'),
  (84, 25, 0, 'Grimms_Fairy_Stories.jpg'),
  (85, 25, 0, 'images.jpg'),
  (87, 24, 1, 'girl_next_door.jpg'),
  (88, 24, 0, 'ill_001.jpg'),
  (89, 23, 1, 'machiavelli.jpg'),
  (90, 23, 0, 'Prince_0.jpg'),
  (91, 22, 1, '72.jpg'),
  (92, 22, 0, 'Mark-Twain.jpg'),
  (93, 22, 0, 'tom.jpg'),
  (94, 21, 1, 'leaves-grass-classic-collection-walt-whitman-cd-cover-art.jpg'),
  (95, 21, 0, 'Why-did-wlat-whitman-write-Leaves-of-Grass.jpg'),
  (96, 20, 1, 'thepictureofdoriangray.jpg'),
  (97, 20, 0, 'the-picture-of-dorian-gray-7.jpg'),
  (98, 19, 1, '7513729.jpg'),
  (99, 19, 0, 'metamorphosis.jpg'),
  (100, 18, 1, 'hermann_Hesse_Siddhartha-500x500.jpg'),
  (101, 18, 0, 'siddhartha.jpg'),
  (102, 17, 1, 'Divine-Comedy-Dante-Alighieri.jpg'),
  (103, 17, 0, 'inferno.jpg'),
  (104, 16, 1, 'importance-being-earnest-a-trivial-comedy-for-serious-oscar-wilde-paperback-cover-art.jpg'),
  (105, 16, 0, 'the_importance_of_being_earnest-1.480x480-75__.jpg'),
  (106, 15, 1, '200px-Yellowwp_med.jpg'),
  (107, 15, 0, 'yellow-wallpaper.jpg'),
  (108, 14, 1, 'J-M-Barrie-s-Peter-Pan-peter-pan-8795389-292-450.jpg'),
  (109, 14, 0, 'PeterPan9.jpg'),
  (110, 13, 1, 'emily-bronte-wuthering-heights-cover-detail.jpg'),
  (111, 13, 0, 'wuthering-heights.jpg'),
  (112, 12, 1, 'Dracpos.jpg'),
  (113, 12, 0, 'dracula_book_cover_1902_doubleday_89.jpg'),
  (114, 11, 1, '9788866611189.225x225-75__.jpg'),
  (115, 11, 0, 'beowulf-j-lesslie-hall-21672257.jpg'),
  (116, 10, 1, 'mysteriousaffairatstyles.jpg'),
  (117, 10, 0, 'the-mysterious-affair-at-styles.jpg'),
  (118, 9, 1, 'emma.jpg'),
  (119, 9, 0, 'emmabk.jpg'),
  (120, 8, 1, '12-years-slave.jpg'),
  (121, 8, 0, 'r3rd.jpg'),
  (122, 7, 1, '295.jpg'),
  (123, 7, 0, 'treasure-island.jpg'),
  (124, 6, 1, '57999781775411499237491Pic.jpg'),
  (125, 6, 0, 'beyond-good-evil-friedrich-wilhelm-nietzsche-paperback-cover-art.jpg'),
  (126, 1, 1, 'ArthurConanDoyle_AStudyInScarlet_annual.jpg'),
  (127, 1, 0, 'cover.jpg'),
  (128, 1, 0, 'study_in_scarlet_sherlock4.jpg'),
  (129, 2, 1, 'A008727.jpg'),
  (130, 2, 0, 'three_man_in_a_boat.jpg');
...
-- Dumping data for table bookmart.users: 6 rows
...
INSERT INTO `users` (`user_id`, `country_id`, `user_type`, `first_name`, `last_name`, `dob`, `email`, `password`, `reset_code`, `phone`, `city`, `avatar`, `profile_desc`, `blocked`, `joined`) VALUES
  ...
  (6, 99, 'normal_user', 'Django', 'Unchained', '0000-00-00', 'django@here.com', '4c01fb5a35ec7a30646994ecc6ef0ba6', NULL, '', 'Kochi', '', '', 0, '2014-09-24 21:03:15'),
  (7, 2, 'normal_user', 'lamer', 'ok', '0000-00-00', 'hola@demo.net', '5b5f4dcec6a0e398562311965ea75933', NULL, '', 'okla', '', '', 0, '2014-09-24 23:49:54');
